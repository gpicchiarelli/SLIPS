...
(format nil "%6s" "éêóï")
(format nil "%6s" "éaób")
(format nil "%6.2s" "abcd")
(format nil "%6.2s" "éêóï")
(format nil "%6.2s" "éaób")
(format nil "%-6.2s" "abcd")
(format nil "%-6.2s" "éêóï")
(format nil "%-6.2s" "éaób")
(format nil "%06.2s" "abcd")
(format nil "%06.2s" "éêóï")
(format nil "%06.2s" "éaób")
(format nil "%+-4d" 3)
(format nil "%+04d" 3)
(format nil "%.0f" 4.0)
(format nil "%#.0f" 4.0)
...
(with-open-file)
(with-open-file ())
(with-open-file "stuff.txt")
(with-open-file "stuff.txt" stuff "r")
(with-open-file ("stuff.txt"))
(with-open-file ("stuff.txt" stuff "r" "w"))
(remove "Temp/wof.dat")

(with-open-file ("Temp/wof.dat" wof "w")
   (printout wof "Hello World" crlf)
   (printout wof "Goodbye World" crlf))
(close wof)

(with-open-file ("Temp/wof.dat" wof)
   (println (readline wof))
   (println (readline wof)))
(close wof)
